...
const Banner = () => {
    return (
        <div className="bg-white bg-opacity-50 px-1">
        <img className="h-[440px] w-full opacity-20 absolute container" src="https://i.ibb.co/sv35XDc/donation-picture.jpg" alt="" />
